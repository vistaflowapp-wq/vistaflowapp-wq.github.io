...
import { Download, Smartphone, Zap, Image as ImageIcon, Shield, Mail, ExternalLink, ChevronRight, Star, Search, Wand2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-orange-500 selection:text-white">
      ...
      <nav className="fixed top-0 w-full z-50 bg-black/50 backdrop-blur-lg border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src="/attached_file_1.png" alt="Vistaflow Logo" className="w-10 h-10 rounded-xl shadow-lg" />
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-2 mb-10">
              <p className="text-xl text-white/80">Stunning HD & 4K wallpapers for your device.</p>
              <p className="text-lg text-white/50 italic">"Shots clicked by real photographers"</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a 
                href="#features"
                className="px-8 py-4 bg-white/5 border border-white/10 rounded-2xl font-bold text-lg hover:bg-white/10 transition-all flex items-center justify-center"
              >
                Explore Features
              </a>
            </div>
          ...
          >
            <motion.div 
              className="relative z-10 rounded-3xl overflow-hidden shadow-2xl border border-white/10 w-full max-w-xs sm:max-w-sm mx-auto"
            >
              <motion.img 
      ...
      <section id="features" className="py-24 px-6 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            { icon: <Zap className="text-orange-500" />, title: "4K & Ultra HD", desc: "Crystal clear quality that brings every pixel to life." },
            { icon: <ImageIcon className="text-blue-500" />, title: "Diverse Categories", desc: "Find wallpapers that match your style." },
            { icon: <Smartphone className="text-green-500" />, title: "Daily Updates", desc: "Fresh content added every day." },
            { icon: <Zap className="text-purple-500" />, title: "Shuffle Mode", desc: "Discover wallpapers effortlessly." },
            { icon: <Shield className="text-red-500" />, title: "Lightweight", desc: "Optimized for performance." },
            { icon: <Wand2 className="text-yellow-500" />, title: "Apply", desc: "Set wallpaper on home, lock screen, or both with a single tap." },
            { icon: <Search className="text-gray-500" />, title: "Search", desc: "Search wallpapers powered by Pexels." }
          ].map((f, i) => (
            <motion.div key={i} whileHover={{ y: -10 }} className="p-8 rounded-3xl bg-white/5 border border-white/10">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="p-8 rounded-3xl bg-orange-500/5 border border-orange-500/20 text-left">
            ...
            <ul className="space-y-3 text-white/60">
              ...
              <li className="flex items-start gap-3">
                <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-orange-500 shrink-0"></div>
                Save your favorite wallpapers directly to your device with one tap.
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-orange-500 shrink-0"></div>
                Easily share wallpapers with friends and across your favorite apps.
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-orange-500 shrink-0"></div>
                Easily set wallpaper on your home or lock screen with a single tap
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-orange-500 shrink-0"></div>
